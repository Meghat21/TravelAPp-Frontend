  ...
  return (
    <section className='max-container flex flex-col padding-container gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <h1 className='bold-52 lg:bold-88'>Kedarkantha 
          Camp Area</h1>
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          We want to be on each of your journey seeking the 
          satisfatcion of seeing the incorruptible beauty of nature.
          we can help you on your adventure around the world in just one app
        </p>
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col ">
            ...
            <p className="bold-20 text-white">Kedarkantha</p>
          </div>
            <div className="flexBetween">
              <div className="flex flex-col">
                <p className="regular-16 block text-gray-20">Distance</p>
                <p className="bold-20 text-white">183km</p>
              </div>
              <div className="flex flex-col">
                <p className="regular-16 block text-gray-20">Elevation</p>
                <p className="bold-20 text-white">10feet</p>
              </div>
            </div>
        </div>
      </div>
